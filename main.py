...
print(testY)
'''
code to generate sample test file test_input.txt
test_input_arr=testY.astype(np.uint8)
g=open('test_input.txt','w')
np.savetxt(g,testY)
...
print(PredictedWithConv)
print(PredictedWithMNN)
